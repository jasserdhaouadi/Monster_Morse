...
# 		print(f"Learn phase 1 begins after {minutes} minutes and {seconds} seconds")
# 		#self.stuff(Trial_Data('level/data/mor1/learn1.dat'))
# 		self.stuff(Trial_Data(r'C:\Users\jasse\Downloads\monster-master\monster-master\level\data\mor1\learn1.dat'))
...
# 		minutes = int(elapsed_time // 60)
# 		seconds = int(elapsed_time % 60)
# 		print(f"Learn phase 2 begins after {minutes} minutes and {seconds} seconds")
# 		#self.stuff(Trial_Data('level/data/mor1/learn2.dat'))
# 		self.stuff(Trial_Data(r'C:\Users\jasse\Downloads\monster-master\monster-master\level\data\mor1\learn2.dat'))
...
# 		t4 = time.time()
# 		self.stuff(Trial_Data(r'C:\Users\jasse\Downloads\monster-master\monster-master\level\data\mor1\test.dat'), True)
# 		elapsed_time = t4 - t1
# 		minutes = int(elapsed_time // 60)
# 		seconds = int(elapsed_time % 60)
# 		print(f"The test begins after {minutes} minutes and {seconds} seconds")
...
class Morse1(Stage):
	...
	def __init__(self,beep=False):
		...
		self.load_sound(os.path.join(self.path,'audio/morse1/new/new_Instr1.ogg')).play()
		self.blank()
		pygame.time.wait(4000)
		image = pygame.image.load(os.path.join(self.path,'images/morse/new/dot.tif'))
		self.draw(image,(self.position_center_width(image),self.position_center_height(image)))
		pygame.display.update()
		pygame.time.wait(2300)
		image = pygame.image.load(os.path.join(self.path,'images/morse/new/dash.tif'))
		self.draw(image,(self.position_center_width(image),self.position_center_height(image)))
		pygame.display.update()
		pygame.time.wait(4200)

		# Hörmal so
		self.play_instruction('audio/morse1/new/new_Instr2.ogg')
		self.draw_stuff('images/morse/new/dot.tif')
		self.stopwatch = Stop_Watch()
		self.stopwatch.start()
		self.play_instruction('audio/morse1/new/puuu.ogg',False)
		pygame.time.wait(500)
		...
		self.draw_stuff('images/morse/dash.tif')
		self.play_instruction('audio/morse1/new/gaaa.ogg',False)
		pygame.time.wait(500)
		...
		#Jetzt probierst du mal!
		self.play_instruction('audio/morse1/new/new_Instr3.ogg')
		...
		print(f"Learn phase 1 begins after {minutes} minutes and {seconds} seconds")
		self.stuff(Trial_Data(r'C:\Users\jasse\Downloads\monster-master\monster-master\level\data\mor1\learn1.dat'))
		self.load_sound(os.path.join(self.path,'audio/morse1/new/new_Instr4.ogg')).play()
		self.blank()
		pygame.time.wait(2000)
		image = pygame.image.load(os.path.join(self.path,'images/morse/dot_dash.tif'))
		self.draw(image,(self.position_center_width(image),self.position_center_height(image)))
		...
		self.play_instruction('audio/morse1/new/new_Instr5.ogg')
		...
		print(f"Learn phase 2 begins after {minutes} minutes and {seconds} seconds")
		self.stuff(Trial_Data(r'C:\Users\jasse\Downloads\monster-master\monster-master\level\data\mor1\learn2.dat'))
		self.play_instruction('audio/morse1/new/new_intro_test.ogg')
		self.log.add_new_log('test')
		t4 = time.time()
		current_correct_answers = 0
		while current_correct_answers < 6:
			current_correct_answers = self.stuff(Trial_Data(r'C:\Users\jasse\Downloads\monster-master\monster-master\level\data\mor1\test.dat'), True)
		elapsed_time = t4 - t1
		minutes = int(elapsed_time // 60)
		seconds = int(elapsed_time % 60)
		print(f"The test begins after {minutes} minutes and {seconds} seconds")
		self.play_instruction('audio/morse1/new/new_Instr1_teil2.ogg')

		
		self.play_instruction('audio/morse1/new/new_Instr2.ogg')
		self.draw_stuff('images/morse/cross.jpg')
		self.stopwatch = Stop_Watch()
		self.stopwatch.start()
		self.play_instruction('audio/morse1/new/wee_only.ogg',False)
		pygame.time.wait(500)
		self.surface.fill(self.bg_blank)
		pygame.display.update()
		pygame.time.wait(500)
		...
		#Jetzt probierst du mal!
		self.play_instruction('audio/morse1/new/new_Instr3.ogg')
		self.stuff(Trial_Data(r'C:\Users\jasse\Downloads\monster-master\monster-master\level\data\mor1\learn3.dat'))

		self.surface.fill(self.bg_blank)
		pygame.display.update()
		pygame.time.wait(500)
		self.play_instruction('audio/morse1/new/genausoweiter.ogg')
		self.log.add_new_log('learn4')
		self.stuff(Trial_Data(r'C:\Users\jasse\Downloads\monster-master\monster-master\level\data\mor1\learn4.dat'))
		self.surface.fill(self.bg_blank)
		pygame.display.update()
		pygame.time.wait(500)
		self.play_instruction('audio/morse1/new/new_intro_test.ogg')
		self.stuff(Trial_Data(r'C:\Users\jasse\Downloads\monster-master\monster-master\level\data\mor1\test2.dat'), test=True)
		self.play_instruction('audio/morse1/quit.ogg')
	...
	def stuff(self,trialdata,test=False):
		...
		self.positive_feedback_sound = self.load_sound(os.path.join(self.path, 'audio/morse1/new/positives_feedback.ogg'))
		self.negative_feedback_sound = self.load_sound(os.path.join(self.path, 'audio/morse1/new/negatives_feedback.ogg'))
